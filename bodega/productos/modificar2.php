...
require("../../conection/conexion.php");
    ...
    try {
        ...
        if ($editar=$result-> fetch(PDO::FETCH_ASSOC)){
            ...
            <div id="cod">
                <div>
                    <a href="product.php" class="close" title="close">x</a>
                    <div id="cab">
                ...
                <form action="upd2.php" method="POST">
                    ...
                    <div>
                    <input type="text" id="inp3" readonly name="nombre_p" value="<?php echo $editar['nombre_p'] ?>">
                    </div>
                    <label id="lab1">Precio</label>
                    <div>
                    <input type="text" id="inp4" readonly name="precio" value="<?php echo $editar['precio'] ?>">
                    </div>
