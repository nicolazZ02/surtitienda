<?php
    ...
    $sentencia1="SELECT * FROM facturas,clientes,usuarios WHERE facturas.id_cliente=clientes.id_cliente and facturas.id_usu=usuarios.id_usu";
    ...
    <form method="post" action="buscar3.php"> 
        ...
        <div id="tag">
            ...
            <table  class="table">
                    ...
                    <?php
                            $buscar=$_POST['buscar'];
                            $cons="SELECT * FROM facturas,clientes,usuarios WHERE n_factu=:ced and facturas.id_cliente=clientes.id_cliente and facturas.id_usu=usuarios.id_usu";
                    ...
                    <tr>
                        ...
                        <td><a id="q1" class="btn btn-success mx-5" href="eliminar2.php?id=<?php echo $move->n_factu?> "><img class="mi" src="../../img/bote1.png" alt=""></a></td>
                        <td><a id="q2" class="btn btn-success" href="modificar2.php?id=<?php echo $move->n_factu?> "><img class="mi" src="../../img/modi2.png" alt=""></a></td>
                    </tr>
                    <?php
                        }
                    ?>
