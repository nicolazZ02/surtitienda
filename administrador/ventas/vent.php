...
<?php
        ...
        <table id="ini">
                ...
                <tr>
                <a href="detal_tempo.php?id=<?php echo $idc ?> &nomb=<?php echo $nomb ?> &apel=<?php echo $ape?> &nombven=<?php echo $nombre ?> &doc=<?php echo $id ?>"><button type="button" class="boton cinco" name="cargar">
                    <div class="icono">
