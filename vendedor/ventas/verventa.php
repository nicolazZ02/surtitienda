...
<body>
    ...
    <div id="efec">
        <h1 id="et">Cambio en efectivo</h1>
        <input id="valor" type="text" value="$<?php echo $dolar?>" readonly>
    </div>
    </div>
    <form method="post"> 
        ...
        <h4	id="h4">Factura Realizada</h4>
            ...
            <table  class="table">
                    ...
                    <tr>
                        ...
                        <td><a id="q2" type='button' class="btn btn-primary mx-5" onclick='window.print();'> <img src="../../img/impre5.png" class="mi" alt="Impresora"></a></td>
                    </tr>
                    <?php
                        }
                    ?>
