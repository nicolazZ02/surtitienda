...
<?php 
    ...
    $sql="INSERT into detalle_factu (n_factu,cod_product,id_usu,cantidad,valor_venta) select n_factu,cod_product,id_usu,cantidad,valor_venta from detalle_tempo WHERE id_usu='$cedu1'";
    $resultado=$bd->prepare($sql);
    $resultado->execute(array());
    ...
    header("Location: calculo.php?id=$idc &ced= $doc &can= $contador &tot= $total &nomb= $nombre &cambio= $cambio ");
